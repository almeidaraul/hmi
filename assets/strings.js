const content = {
	...
	"es_UY": {
		...
		take_now_plural: "Debe tomar % unidades de insulina ahora o % en 15 minutos (%).",
	...
	"es_ES": {
		...
		bg: "Glicemia: ",
		carbs: "Carbohidratos: ",
		take_now_singular: "Tome % unidad de insulina ahora o % en 15 minutos (%).",
    ...
    "es_MX": {
		home: "Inicio",
		settings: "Ajustes",
		bg: "Nivel de glucosa en la sangre: ",
		carbs: "Carbohidratos: ",
		take_now_singular: "Tome % unidad de insulina ahora o % en 15 minutos (%).",
		take_now_plural: "Tome % unidades de insulina ahora o % en 15 minutos (%).",
		changes_are_saved: "Los cambios son guardados automáticamente.",
